...
MAX_S_CONE_CONTRAST = 0.45
Fs = 100

# Predictive models for each device
ssp1 = SSP.from_json(
    "/Users/jtm545/Projects/BakerWadeBBSRC/data/STLAB_1_York.json"
)
ssp2 = SSP.from_json(
    "/Users/jtm545/Projects/BakerWadeBBSRC/data/STLAB_2_York.json"
)
